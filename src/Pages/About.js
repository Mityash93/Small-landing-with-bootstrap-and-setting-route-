          ...
          <Row>
            <Col sm={3}>
              <Nav variant="pills" className="flex-column mt-2">
                ...
                <Nav.Item>
                  <Nav.Link style={{ cursor: "pointer" }} eventKey="third">
                    Programming
                  </Nav.Link>
                </Nav.Item>
              </Nav>
              ...
              <Tab.Content className="mt-3">
                <Tab.Pane eventKey="first">
                  <img
                    width="100%"
                    height="100%"
                    src="https://cdn.sanity.io/images/599r6htc/localized/7e69ee54e0ffd0e3e3ea67c66847b9ad5b9accaa-1600x929.png?w=1200&q=70&fit=max&auto=format"
                    alt="1"
                  />
                  <p className="mt-3">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Quidem incidunt totam natus quod ex ullam officia fuga
                    aperiam sint a.
                  </p>
                </Tab.Pane>
                <Tab.Pane eventKey="second">
                  <img
                    width="100%"
                    height="100%"
                    src="https://images.ctfassets.net/ooa29xqb8tix/2IwSz500ZOmoyWWCoc28as/16c9a0ca05d3b125c9df82e0d6522718/DraggedImage.jpeg"
                    alt="2"
                  />
                  <p className="mt-3">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
